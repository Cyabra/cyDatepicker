	...
	return (
		<div className="px-4 py-8">
			...
			<h1 className="text-center text-xl font-semibold">
				<pre className="mx-auto max-w-max rounded bg-gray-200 px-2 text-lg text-gray-600">
			...
			<div className="mx-auto flex max-w-3xl flex-row flex-wrap py-4">
				<div className="flex w-full flex-row flex-wrap pr-2 sm:w-1/3 sm:flex-col">
				...
				<div className="flex w-full flex-col pr-2 sm:w-1/3">
					<div className="mb-2">
				...
				<div className="ml-auto flex w-full flex-col pr-2 sm:w-2/3">
					<hr className="my-3" />

					<h1 className="col-span-3 mb-2 text-center text-lg font-semibold">
						Disable Dates
					</h1>
					...
					<div className="grid w-full grid-cols-2 gap-3">
						<div className="mb-2 w-full">
							...
							<input
								className="w-full rounded border border-gray-200 px-4 py-2 sm:w-full"
								id="startDate"
								type="date"
					...
					<div className="col-span-3 mb-2">
						<button
							...
							className="w-full rounded-lg bg-black p-2 text-center text-lg text-white"
						>
							Add
						</button>
					</div>

					<div className="grid-col-2 col-span-3 mb-2 grid">
						{disabledDates.map((range, index) => (
							<div className="mb-2 p-2" key={index}>
								<button
									className="rounded-xl bg-red-500 p-2 text-center text-white"
									onClick={() => {
