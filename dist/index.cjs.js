...
const DatepickerContext = /*#__PURE__*/require$$0.createContext({
  arrowContainer: null,
  asSingle: false,
...
function previousMonthBy(date) {
  if (!dateIsValid(date)) return require$$0$1().toDate();
...
function firstDayOfMonth(date) {
  return require$$0$1(date || require$$0$1()).startOf('month').toDate();
}
function endDayOfMonth(date) {
  return require$$0$1(date || require$$0$1()).endOf('month').toDate();
}
...
const ItemTemplate = /*#__PURE__*/require$$0.memo(props => {
  const {
    primaryColor,
    period,
    changePeriod,
...
const Datepicker = props => {
  ...
  const [inputRef, setInputRef] = require$$0.useState(/*#__PURE__*/require$$0.createRef());
  // Custom Hooks use
